    ...
    <div>
            <section className="w-screen py-5">
                <div className="mx-auto grid max-w-screen-lg grid-cols-1 gap-5 p-5 sm:grid-cols-2 md:grid-cols-2 lg:gap-10">
                    ...
                    {/* Manage Products */}
                    <a href='/admin/manage-products' className="group h-full overflow-hidden rounded-lg border-2 border-gray-200 border-opacity-60 shadow-lg">
                        <div
                            key={1}
                        ...
                        <div className="py-4 px-6">
                            <h2 className="title-font text-sm font-semibold uppercase tracking-widest text-orange-600">Manage Products</h2>
                            <h1 className="title-font mb-3 text-xl font-extrabold tracking-wide text-gray-800">Admin Only Access</h1>
                            <p className="line-clamp-6 mb-3 text-gray-500">Manage available stock products here.</p>
                        </div>
                    ...
                    <div
                        ...
                        <div className="py-4 px-6">
                            <h2 className="title-font text-sm font-semibold uppercase tracking-widest text-orange-600">Manage Orders</h2>
                            <h1 className="title-font mb-3 text-xl font-extrabold tracking-wide text-gray-800">Manage user orders like editing their carts</h1>
                            <p className="line-clamp-6 mb-3 text-gray-500">Manage User Related Orders here.</p>
                        </div>
                        <div className="flex justify-center px-6 pb-4">
                            <button className="group flex items-center justify-center rounded-md bg-yellow-500 px-6 py-2 text-white transition hover:bg-yellow-600">
